...
public class Exercise1 {
    ...
    public void acceptGreaterThan21OthersRemove() {
        ...
        candidates.entrySet()
            .forEach(personStatusEntry -> personStatusEntry.setValue(Status.ACCEPTED));
    ...
    public void getStatus() {
        ...
        Function<Person, Status> getStatus = person -> candidates
            .getOrDefault(person, Status.UNKNOWN);
