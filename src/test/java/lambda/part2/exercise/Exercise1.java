...
public class Exercise1 {
    ...
    public void sameAgesCheckerUsingBiPredicate() {
        ...
        BiPredicate<Person, Person> sameAgesChecker = (person, person21) -> person1.getAge() == person21.getAge();
    ...
    private static BiFunction<Person, Person, Integer> createExtractorAgeOfPersonWithTheLongestFullName(Function<Person, String> fullNameExtractor) {
        return (person1, person2) -> {
            String personOneFullName = fullNameExtractor.apply(person1);
            String personTwoFullName = fullNameExtractor.apply(person2);
            int compare =
                    Integer.compare(personOneFullName.length(), personTwoFullName.length());
            if (compare < 0) {
